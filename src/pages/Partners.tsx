    ...
    <div className="container mx-auto px-4 py-12 md:py-16">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Nenhum parceiro ainda</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {brands.map((brand) => (
            <Card
              key={brand.id}
              className="overflow-hidden group hover:shadow-xl transition-all duration-300 border border-border/80 bg-card rounded-xl"
            >
              <div className="aspect-[2/1] overflow-hidden bg-muted/50 flex items-center justify-center p-4">
                {brand.logo_file ? (
                  <img
                  ...
                  <div className="w-16 h-16 rounded-full bg-orange-500/10 flex items-center justify-center text-orange-500 font-bold text-xl">
                    {brand.name.charAt(0).toUpperCase()}
                  </div>
                )}
              </div>
              <CardContent className="p-5">
                <h3 className="text-lg font-bold text-foreground mb-2 line-clamp-1 group-hover:text-orange-600 transition-colors">
                  {brand.name}
                </h3>
                ...
                {brand.website && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm text-orange-500 hover:text-orange-400 font-medium"
                  >
